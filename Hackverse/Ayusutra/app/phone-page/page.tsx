...
export default function PhonePage() {
  ...
  const handlePhoneSuccess = (phoneNumber: string) => {
    ...
    // Store phone number in session storage for the registration page
        ...
        <div className="relative z-10 flex flex-col justify-center items-center p-12 text-center">
          <div className="mb-8">
            ...
            <p className="text-lg text-muted-foreground max-w-md">
              Start your wellness journey by verifying your phone number. 
              This helps us provide you with personalized Ayurvedic recommendations.
            </p>
          </div>
          ...
          <Card className="bg-card border-border shadow-lg">
            <CardHeader className="text-center space-y-4">
              ...
              <CardDescription className="text-muted-foreground">
                Enter your phone number to continue with your upyogi account creation
              </CardDescription>
            </CardHeader>
